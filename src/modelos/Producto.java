...
public class Producto {
    ...
    public Producto(int id_producto,int id_cat, String descrip, String codig, String tipo_afec, Double precio, String estado, int stock, int id_marca, int id_fac_cat7_igv) {
        this.id_cat = id_cat;
