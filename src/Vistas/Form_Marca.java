...
public class Form_Marca extends javax.swing.JDialog {
    ...
    MarcaDAO controlador = new MarcaDAO(); //llamamos al mentenimiento general del objeto
    SQL sql = new SQL(); 
...
//        validar.validarSoloNumeros(txtDescripcion);
        if (id_marca == 0) {
            ...
            String descripcion = controlador.getMarca().getDescripcion();
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (id_marca == 0) {
                ...
                Marca marca = new Marca(0, leeDescripcion(), 1, id_usuario, id_sede);
                ...
                Marca marca = new Marca(leeId(), leeDescripcion(), 1, id_usuario, id_sede);
