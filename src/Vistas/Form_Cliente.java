...
import utilidades.ConsultaWebService;
...
public class Form_Cliente extends javax.swing.JDialog {
    ...
    ClienteDAO controlador = new ClienteDAO(); //llamamos al mentenimiento general del objeto      
    ...
    TipodocDAO controladorTipodoc = new TipodocDAO();//llamamos al mentenimiento general del objeto
    SQL sql = new SQL();
    ...
    public Form_Cliente(java.awt.Frame parent, boolean modal, int idcliente, int ver,
        ...
        if (idcliente == 0) {
            ...
            String tipodoc = controlador.getCliente().getTipodoc();
            String numdoc = controlador.getCliente().getNum_documento();
            String direccion = controlador.getCliente().getDireccion();
            String cel1 = controlador.getCliente().getCelular();
            String correo = controlador.getCliente().getEmail();
            String nombres = controlador.getCliente().getNomcompleto();
            String observaciones = controlador.getCliente().getObservacion();
...
//            ////////////////////////////////////////////////////////////////////////////
    ...
    public void lista_Tipos_Doc() {//LISTA TODAS EMPRESAS 
        lista_ObTipodoc = (ArrayList<Tipodoc>) controladorTipodoc.listar();
    ...
    private void txtNumeroDocumentoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNumeroDocumentoKeyReleased
        ...
        int longiDoc = sql.obtenerEntero("Select longitud from tipodoc where id_tipodoc='" + lblIdtipodoc.getText() + "'");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        int longiDoc = sql.obtenerEntero("Select longitud from fac_cat6_tipodoc where id_tipodoc='" + lblIdtipodoc.getText() + "'");
     ...
     if (txtNumeroDocumento.getText().equalsIgnoreCase("")) {
        ...
        try {
            if (idcliente == 0) {
                ...
                Cliente cliente = new Cliente(0, leeTipoDocumento(), leeNumeroDocumento(),
                ...
                if (!sql.valida_Campos(consulta)) {
                    String consultaCli = "Select num_documento from cliente where "
                            + " num_documento='" + leeNumeroDocumento() + "' and estado='1'  ";
                    if (sql.valida_Campos(consultaCli)) {
                        JOptionPane.showMessageDialog(null, "El Cliente ingresado ya existe.", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
                        txtNumeroDocumento.setText("");
                        txtNumeroDocumento.requestFocusInWindow();
                        return;
                ...
                Cliente cliente = new Cliente(leeId(), leeTipoDocumento(), leeNumeroDocumento(),
                        leeDireccion(), leeCelular1(), leeCorreo(), 1, leeNomCompleto(),
                        id_usuario, id_sede, leeObservaciones(), leeId_tipodoc());
