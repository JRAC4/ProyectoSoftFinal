...
public class Form_Grupo_Igv extends javax.swing.JDialog {

    ConfigGeneral config = new ConfigGeneral();
    GrupoIgvDAO controlador = new GrupoIgvDAO(); //llamamos al mentenimiento general del objeto
    SQL sql = new SQL();
...
//        this.id_sedes=id_usuarios;
    ...
    public Form_Grupo_Igv(java.awt.Frame parent, boolean modal, int idrecepcionado, int ver) {
        super(parent, modal);
        initComponents();
...
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (idrecepcionado == 0) {
                ...
                GrupoIgv cat7_igv = new GrupoIgv(0, leeCodigo(), leeDescripcion(), leeIgv(),1);
                ...
                GrupoIgv cat7_igv = new GrupoIgv(leeId(), leeCodigo(), leeDescripcion(), 
                        leeIgv(),1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Grupo_Igv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Grupo_Igv dialog = new Form_Grupo_Igv(new javax.swing.JFrame(), true, 0, 0);
