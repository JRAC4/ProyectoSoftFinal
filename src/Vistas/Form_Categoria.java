...
//        validar.validarSoloNumeros(txtDescripcion);
        if (id_categoria == 0) {
            ...
            String descripcion = controlador.getCategoria().getDescripcion();
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (id_categoria == 0) {
                ...
                Categoria categoria = new Categoria(0, leeDescripcion(), 1, id_usuario, id_sede);
                ...
                Categoria categoria = new Categoria(leeId(), leeDescripcion(), 1, id_usuario, id_sede);
