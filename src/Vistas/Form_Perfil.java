...
public class Form_Perfil extends javax.swing.JDialog {
    ...
    PerfilDAO controlador = new PerfilDAO(); //llamamos al mentenimiento general del objeto 
...
//            deshabilitarAlm();
            ...
            String descripcion = controlador.getPerfil().getDescripcion();
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (idrecepcionado == 0) {
                ...
                Perfil perfil = new Perfil(0, leeDescripcion(), 1);
 ...
 valor = 1;
                ...
                Perfil perfil = new Perfil(leeId(), leeDescripcion(), 1);
